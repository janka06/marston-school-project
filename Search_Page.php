            ...
            <body>
                <div class="textbox">
                    ...
                    <form action="Cal_Page.php" method="post">
                        ...
                        <input type="hidden" name="teacher" id="selectedTeacher" required>
                        <button type="submit" class="button">3. Tālāk</button>
                    </form>
                ...
                <script>
                    document.querySelector('form[action="Cal_Page.php"]').addEventListener('submit', function(event) {
                        const selectedSubject = document.querySelector('#subjects li.selected');
                        const selectedTeacher = document.querySelector('#teachers li.selected');

                        if (!selectedSubject || !selectedTeacher) {
                            event.preventDefault(); // Prevents form submission
                            alert('Please select both a subject and a teacher.');
                        } else {
                            document.getElementById('selectedSubject').value = selectedSubject.textContent;
                            document.getElementById('selectedTeacher').value = selectedTeacher.textContent;
                        }
                    });
                </script>
            </body>
